    ...
    <div className="dashboard-shell">
      ...
      >
        ...
        <div className="sidebar-bottom">
          ...
          <Link to={`/${role}/profile`} className="sidebar-user">
        ...
        <header className="dashboard-topbar">
          <div className="inline-row">
            ...
            <div className="breadcrumb">
              My workspace <span>/ {current}</span>
            </div>
          </div>
          <div className="topbar-actions">
            ...
            <Dropdown label={<Avatar name={user.name} src={user.picture} />}>
              <Link to={`/${role}/profile`}>Edit profile</Link>
