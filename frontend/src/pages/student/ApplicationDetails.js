  ...
  if (!app)
    return (
      <EmptyState
        ...
        action={
          <ButtonLink to="/student/applications">My applications</ButtonLink>
        }
      />
    );
      ...
      <Card style={{ marginBottom: 24 }}>
        ...
        {["Rejected", "Withdrawn"].includes(app.status) && (
          <p className="note-box">
            This application is {app.status.toLowerCase()}. Your next
            opportunity is still ahead.
          </p>
        )}
      </Card>
          ...
          <Card>
            ...
            >
              ...
              <p className="banner-note">
                Only visible in your student workspace.
              </p>
