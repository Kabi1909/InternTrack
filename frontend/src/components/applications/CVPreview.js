    ...
    <>
      ...
      >
        {application.cvData ? (
          <>
            <p className="muted">
              This document was uploaded in your demo browser.
            </p>
            <a
          ...
          <>
            <p className="banner-note">
              Illustrative CV preview — no real PDF is attached to seeded demo
              records.
            </p>
            <div className="cv-preview" style={{ margin: "20px 0" }}>
              ...
              <p>
                Projects: Collaborative web applications, accessible interfaces,
